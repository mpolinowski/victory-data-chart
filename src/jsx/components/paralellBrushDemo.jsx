...
import { VictoryBrushLine, VictoryAxis, VictoryChart, VictoryLabel, VictoryLine } from 'victory'
...
const data = [
  ...
  class ParalellBrushChart extends React.Component {
    constructor() {
      super();
...
export default ParalellBrushChart